  ...
  const renderButton = () =>{
    ...
    switch(connectionStatus?.data?.status){
      ...
      case "received":
        return (
           <div className='flex gap-2 justify-center'>
            <button onClick={() => acceptRequest(connectionStatus.data.requestId
             ...
             className='rounded-full p-1 flex items-center justify-center bg-green-500 hover:bg-green-700 text-white'
            >
              <Check size={16}/>
            </button>
            <button
              onClick={() => rejectRequest(connectionStatus.data.requestId)}
              className='rounded-full p-1 flex items-center justify-center bg-red-500 hover:bg-red-700 text-white'
            >
              <X size={16}/>
            </button>
           </div>
        ...
        case "connected":
          return(
            <button className='px-3 py-1 round-full text-sm bg-green-500 text-white flex items-center'>
