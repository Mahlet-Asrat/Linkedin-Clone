			...
			{isEditing && (
				<div className='mt-4'>
					...
					<button
						...
						className='bg-primary cursor-pointer text-white py-2 px-4 rounded hover:bg-primary-dark transition duration-300'
					>
						Add Education
					</button>
				</div>
			...
			{isOwnProfile && (
				<>
					{isEditing ? (
						<button
							onClick={handleSave}
							className=' cursor-pointer mt-4 bg-primary text-white py-2 px-4 rounded hover:bg-primary-dark
						...
						<button
							...
							className='cursor-pointer mt-4 text-primary hover:text-primary-dark transition duration-300'
						>
							Edit Education
						</button>
					)}
