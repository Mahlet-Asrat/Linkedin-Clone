      ...
      {isEditing && (
        <div className="mt-4 flex">
          ...
          <button
           ...
           className="bg-primary cursor-pointer text-white py-2 px-4 rounded-r hover:bg-gray-950 transition duration-300">
            Add Skill
          </button>
        </div>
      )}
      {isOwnProfile && (
        <>
          {isEditing ? (
            <button 
              onClick={handleSave}
              className="mt-4 cursor-pointer bg-primary text-white py-2 px-4 rounded hover:bg-gray-950 transition duration-300"
            >
              Save Changes
            </button>
          ) : (
